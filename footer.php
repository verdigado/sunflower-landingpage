		...
		<div class="site-footer__content">
			...
			<div class="d-flex justify-content-between w-100 site-footer__content--top">
				<div class="vendorflex row">
					<p class="small">
						Das grüne cms
						ist ein Angebot der <a href="https://verdigado.com/" target="_blank"><nobr>verdigado eG</nobr></a>
					</p>
				</div>
			...
			<div class="d-flex w-100 justify-content-between site-footer__content--bottom">
				...
				<div class="footerlogo">
					...
					if ( has_custom_logo() ) {
						...
						$sunflower_logo = wp_get_attachment_image_src(
						...
						if ( 'light' === $sunflower_color_scheme ) {
							$sunflower_logo = 'assets/img/logo-diegruenen.svg';
						} else {
							$sunflower_logo = 'assets/img/logo-diegruenen-auf-tanne.svg';
						}

						printf(
							'<img src="%s" class="img-fluid" alt="Logo BÜNDNIS 90/DIE GRÜNEN">',
							esc_url( sunflower_parent_or_child( $sunflower_logo ) )
						);
					}
